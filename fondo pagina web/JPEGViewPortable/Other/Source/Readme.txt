...
user in an INI file next to JPEGViewPortable.exe called JPEGViewPortable.ini.
...
copy AppNamePortable.ini from this directory to JPEGViewPortable.ini next to
JPEGViewPortable.exe. The options in the INI file are as follows:
